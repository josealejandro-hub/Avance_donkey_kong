...
MUSIC_PATH = os.path.join(
    ...
    'assets',
    'images',
    'Gloomy Galleon Mechanical Fish - Donkey Kong 64.mp3'
)
...
barrel_img = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'barrels', 'barrel.png')),
    (section_width * 1.5, section_height * 2)
)

flames_img = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'fire.png')),
    (section_width * 2, section_height)
)

barrel_side = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'barrels', 'barrel2.png')),
    (section_width * 2, section_height * 2.5)
)

dk1 = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'dk', 'dk1.png')),
    (section_width * 5, section_height * 5)
)

dk2 = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'dk', 'dk2.png')),
    (section_width * 5, section_height * 5)
)

dk3 = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'dk', 'dk3.png')),
    (section_width * 5, section_height * 5)
)

peach1 = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'peach', 'peach1.png')),
    (2 * section_width, 3 * section_height)
)

peach2 = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'peach', 'peach2.png')),
    (2 * section_width, 3 * section_height)
)
...
fireball2 = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'fireball2.png')),
    (1.5 * section_width, 2 * section_height)
)

hammer = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'hammer.png')),
    (2 * section_width, 2 * section_height)
)

standing = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'mario', 'standing.png')),
    (2 * section_width, 2.5 * section_height)
)

jumping = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'mario', 'jumping.png')),
    (2 * section_width, 2.5 * section_height)
)

running = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'mario', 'running.png')),
    (2 * section_width, 2.5 * section_height)
)

climbing1 = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'mario', 'climbing1.png')),
    (2 * section_width, 2.5 * section_height)
)

climbing2 = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'mario', 'climbing2.png')),
    (2 * section_width, 2.5 * section_height)
)

hammer_stand = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'mario', 'hammer_stand.png')),
    (2.5 * section_width, 2.5 * section_height)
)

hammer_jump = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'mario', 'hammer_jump.png')),
    (2.5 * section_width, 2.5 * section_height)
)

hammer_overhead = pygame.transform.scale(
    pygame.image.load(os.path.join(ASSETS, 'mario', 'hammer_overhead.png')),
...
# ========= NIVEL 2 (CORREGIDO BIEN) =========
{
    ...
    'hammers': [
        (6, row4_top + section_height)
    ],

    # 👇 Princesa apoyada en el riel final
    'target': (20, row6_y - section_height, 3)
}
]
